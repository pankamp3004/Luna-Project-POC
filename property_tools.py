...
TOOLS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "✗ The email is from a platform (RentCafe, Zillow, etc.) and contains metadata like\n"
            "  'Beds: Studio', 'Rent budget: $950', 'Move-in date: ...' — this is platform data, NOT the prospect asking\n"
            "✗ The prospect uses general interest phrases: 'discuss details', 'details about moving',\n"
            "  'moving details', 'learn more', 'interested in' — these are NOT pricing questions\n"
            "✗ The prospect only says 'I like it' / 'contact me' / 'I want to move here' — no pricing question\n"
            ...
            "**USAGE:**\n"
            "- If unit number mentioned by prospect: call with unit parameter\n"
            "- Returns 'requested_unit' with exact details for that unit\n"
            "- Also returns 'available_now' and 'available_soon' lists\n\n"
            "**IMPORTANT:** Platform metadata (Beds/Budget fields from RentCafe etc.) does NOT count as the prospect asking about pricing."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
